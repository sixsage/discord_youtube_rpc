...
const videoIdToYoutubeUrl = (id: string): string => `https://www.youtube.com/watch?v=${id}`;
...
export async function getVideoDetails(params: VideoDetailsParams): Promise<YoutubeVideoDetails> {
